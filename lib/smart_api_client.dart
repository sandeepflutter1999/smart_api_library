...
class SmartApiClient {
  ...
  ///
  /// Pass [forceRaw]: true to send [body] exactly as given (skipping file
  /// detection and JSON-map handling entirely) — useful for endpoints that
  /// expect a raw string/XML/pre-encoded payload instead of a JSON map.
  ...
  /// detection as [post] applies to [body] and [files], including
  /// [forceRaw].
